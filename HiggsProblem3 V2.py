...
for Hm in H_mass:
    DCS = lambda z: (((2 * FSC**2 * a_H * Z**2) / (m_e_MeV**2)) * z * ((1 + (2/3)*(m_e_MeV**2 / Hm**2)*((1-z)/z**2)) / (1 + ((m_e_MeV**2 / Hm**2)*((1-z)/z**2)))**2)) * np.log(184*np.power(Z, -1/3))
...
def Hee_GeV(mass):
    ...
    return [e1_Energy, e2_Energy, e1_Energy * np.random.normal(1, 0.107*np.sqrt(e1_Energy)), e2_Energy * np.random.normal(1, 0.107*np.sqrt(e1_Energy))]
...
for i in Test_H_Masses:
    ...
    c1.SaveAs(r'/home/ehl857/Documents/MPAG HIGGS/Higgs Problem 3 Plots/NEW Problem 3D/E1 {} MeV Higgs (No Smear).png'.format(i*1000))
    ...
    c2.SaveAs(r'/home/ehl857/Documents/MPAG HIGGS/Higgs Problem 3 Plots/NEW Problem 3D/E2 {} MeV Higgs (No Smear).png'.format(i*1000))
    ...
    leg_NS.Draw()
    c3.SaveAs(r'/home/ehl857/Documents/MPAG HIGGS/Higgs Problem 3 Plots/NEW Problem 3D/Combined {} MeV Higgs (No Smear).png'.format(i*1000))
    ...
    c4.SaveAs(r'/home/ehl857/Documents/MPAG HIGGS/Higgs Problem 3 Plots/NEW Problem 3D/E1 {} MeV Higgs (Smear).png'.format(i*1000))
    ...
    c5.SaveAs(r'/home/ehl857/Documents/MPAG HIGGS/Higgs Problem 3 Plots/NEW Problem 3D/E2 {} MeV Higgs (Smear).png'.format(i*1000))
    ...
    leg_S.Draw()
    c6.SaveAs(r'/home/ehl857/Documents/MPAG HIGGS/Higgs Problem 3 Plots/NEW Problem 3D/Combined {} MeV Higgs (Smear).png'.format(i*1000))
    ...
    leg_hl_NS.Draw()
    c7.SaveAs(r'/home/ehl857/Documents/MPAG HIGGS/Higgs Problem 3 Plots/NEW Problem 3D/High Low Combined {} MeV Higgs (No Smear).png'.format(i*1000))
    ...
    leg_hl_S.Draw()
    c8.SaveAs(r'/home/ehl857/Documents/MPAG HIGGS/Higgs Problem 3 Plots/NEW Problem 3D/High Low Combined {} MeV Higgs (Smear).png'.format(i*1000))


    # plt.figure(figsize=(13.3, 10.0))
    # plt.title(f'Expected Calorimeter Energy Deposits for a {i*1000} MeV Higgs Boson (No Smearing)')
    # plt.xlabel('Energy [GeV]')
    # plt.ylabel('Entries')
    # plt.hist(energies_1_NS, bins=100, color='blue', alpha=0.5, label='Electron 1')
    # plt.hist(energies_2_NS, bins=100, color='red', alpha=0.5, label='Electron 2')
    # plt.subplots_adjust(0.15, 0.15, 0.9, 0.9)
    # plt.show()
    # plt.clf()
    # plt.close()
    #
    # plt.figure(figsize=(13.3, 10.0))
    # plt.title(f'Expected Calorimeter Energy Deposits for a {i*1000} MeV Higgs Boson (Smearing)')
    # plt.xlabel('Energy [GeV]')
    # plt.ylabel('Entries')
    # plt.hist(energies_1_S, bins=100, color='blue', alpha=0.5, label='Electron 1')
    # plt.hist(energies_2_S, bins=100, color='red', alpha=0.5, label='Electron 2')
    # plt.subplots_adjust(0.15, 0.15, 0.9, 0.9)
    # plt.show()
    # plt.clf()
    # plt.close()
...
for m in range(2, 50):
    ...
    DCS = lambda z: ((2 * FSC**2 * a_H * Z**2) / (m_e_MeV**2)) * z * ((1 + (2/3)*(m_e_MeV**2 / m**2)*((1-z)/z**2)) / (1 + ((m_e_MeV**2 / m**2)*((1-z)/z**2)))**2) * np.log(184*np.power(Z, -1/3))
